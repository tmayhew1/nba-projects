...
tp_df_4 = df %>% left_join(lga,by = join_by(Year)) %>% mutate(
...
tp_df_4 %>% filter(X2PAdd > 0,X3PAdd > 0,FTAdd > 0,X0.3eff>0,X3.10eff>0,X10.16eff>0,X16.3eff>0) %>% 
  arrange(desc((X3PAdd^2)+(FTAdd^2)+(X0.3eff^2)+(X3.10eff^2)+(X10.16eff^2)+(X16.3eff^2)))